...
const RecruitmentFormPage = () => {
  ...
  return (
    <div className="recruitment-form-page min-h-screen overflow-y-auto">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-10">
        ...
        >
          Join Our <span style={{ color: "var(--color-rich-earth)" }}>Team</span>
        </motion.h1>
        <motion.p
        ...
        >
          Fill in your details and upload your images. We’ll get back to you soon. Upload images for all required profiles and ensure they are complete before submitting.
        </motion.p>
